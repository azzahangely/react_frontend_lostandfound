          ...
          <tbody>
            {todos.map(todo => (
              <tr key={todo.found_table_id}>
                <td className="px-4 py-2 text-center">{todo.found_item_id}</td>
                <td className="px-4 py-2 text-center">{todo.item_name}</td>
                <td className="px-4 py-2 text-center">{todo.description}</td>
                <td className="px-4 py-2 text-center">{todo.location_found}</td>
                <td className="px-4 py-2 text-center">{todo.date_found}</td>
                ...
                <td className="px-4 py-2">
                  <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" 
                    onClick={() => handleDelete(todo.found_item_id)}>
                    Delete
                  </button>
                </td>
              </tr>
